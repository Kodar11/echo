...
electron.contextBridge.exposeInMainWorld('electron', {
  ...
  getIndexingFailures: () => ipcInvoke('getIndexingFailures'),
  retryIndexingFailure: (input) => ipcInvoke('retryIndexingFailure', input),
  ignoreIndexingFailure: (input) => ipcInvoke('ignoreIndexingFailure', input),
  getIgnoreRules: () => ipcInvoke('getIgnoreRules'),
  addIgnoreRule: (input) => ipcInvoke('addIgnoreRule', input),
  setIgnoreRuleEnabled: (input) => ipcInvoke('setIgnoreRuleEnabled', input),
  deleteIgnoreRule: (input) => ipcInvoke('deleteIgnoreRule', input),
  exportBackup: (input) => ipcInvoke('exportBackup', input),
